...
public class FHistoriqueCoursClient extends javax.swing.JDialog {
    ...
    public void initialiserAffichage( LocalDate date ){
        ...
        tousLesCours.addAll(Client.getCoursFuturs());
        tousLesCours.addAll(Client.getCoursPasses());
    ...
    public void envoyerSalleClientVersHistorique(Salle maSalle, Client client){
